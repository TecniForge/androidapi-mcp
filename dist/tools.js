...
export const TOOLS = [
    ...
    // ────────────────────────────────────────────────────────────────────────────
    {
        ...
        description: "Send a one-time password (OTP) to a phone number via SMS or WhatsApp. " +
    ...
    },
    {
        ...
        description: "Verify an OTP that was entered by the user. Returns success if the OTP is valid and not expired.",
        annotations: { readOnlyHint: true, openWorldHint: true },
        inputSchema: {
            type: "object",
            required: ["otp"],
    ...
    },
    {
        ...
        description: "Send an SMS campaign to multiple phone numbers and/or contact groups. " +
    ...
    // ────────────────────────────────────────────────────────────────────────────
    {
        ...
        description: "Get available SMS gateways and partner device rates. " +
    ...
    // ────────────────────────────────────────────────────────────────────────────
    {
        ...
        description: "Send a single WhatsApp message to one recipient. " +
    ...
    },
    {
        ...
        description: "Send a WhatsApp campaign to multiple recipients or contact groups. " +
    ...
    },
    {
        ...
        description: "Generate a QR code to link a brand-new WhatsApp account. " +
    ...
    },
    {
        ...
        description: "Send a USSD / MMI request from a linked Android device (e.g. check balance with *123#). " +
    ...
    // ────────────────────────────────────────────────────────────────────────────
    {
        ...
        description: "List available URL shorteners you can use in SMS and WhatsApp campaigns. " +
